# 個人開発 💻 とおしゃべり ☕ とテニス 🎾 が好きな、プロダクトをグロースさせるのが好きなエンジニアです 🚀
...
- **YouTube**: 登録者数0→168万人に成長（パチンコ業界No.1チャンネル）
  - 0から動画ディレクターとしてチャンネル育成
- **[個人ブログ運営](https://slotana777.com)**: 月間20万PV達成
  - エンジニア1年目で自動記事更新プログラムを開発
  - Python自動化により記事作成・投稿を完全自動化
...
高市早苗氏が「馬車馬の如く働く」と宣言した2025年、私はエンジニアとしての働き方の未来を模索しています。

それは、自分自身も技術を磨き続けながら、生成AIという強力なパートナーに馬車馬の如く働いてもらうことで、
...
- 実務プロジェクト: Django + AWS Bedrock APIでRAGチャットボット・AI文章校正ツールを短期間で開発

生成AIは単なるツールではなく、エンジニアリングの可能性を広げるパートナー。
私はそのポテンシャルを最大限に引き出し、チームに圧倒的な価値を届け続けたいです。

**今後の展望**:
この「AI駆動開発」のノウハウをチームに還元し、組織全体の生産性向上に貢献することが私の目標です。
**エンジニアと生成AIの協業を組織として模索する企業で、この技術を磨き、チームと共に成長したい**と考えています。
